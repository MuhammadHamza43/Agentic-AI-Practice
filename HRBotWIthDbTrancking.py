...
class DatabaseManager:
    ...
    def update_thread_messages(self, thread_id, messages, input_tokens=0, output_tokens=0):
    ...
    def _setup_database(self):
        ...
        setup_conn = psycopg.connect(self.postgres_url, connect_timeout=CONNECTION_TIMEOUT)
